...
import ItemAddedIndicator from '../components/ItemAddedIndicator';
          ...
          <div className="mx-auto max-w-2xl lg:max-w-7xl">
            {itemAdded && (
              <ItemAddedIndicator
                ...
                timeoutId={timeoutId}
                currentItemInCart={currentItemInCart}
              />
            )}
